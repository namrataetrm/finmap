...
namespace ExcelUploadgridApp.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ExcelUploadController1 : ControllerBase
    {
        private readonly AppDbContext _context;
        private readonly DbContextOptions<AppDbContext> _dbContextOptions;
        private readonly ILogger<ExcelUploadController1> _logger;
        public ExcelUploadController1(AppDbContext context, DbContextOptions<AppDbContext> dbContextOptions, ILogger<ExcelUploadController1> logger)
        {
            _context = context;
            _dbContextOptions = dbContextOptions;
            _logger = logger;
